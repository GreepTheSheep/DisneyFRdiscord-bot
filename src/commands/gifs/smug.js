...
exports.execute = async (interaction, commands) => {
    ...
    if (personne) embed.setDescription(`<@${interaction.member.id}> boude à <@${personne.id}> 😒`);
    else embed.setDescription(`<@${interaction.member.id}> boude 😒`);
