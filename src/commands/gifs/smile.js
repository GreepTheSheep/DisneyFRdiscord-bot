...
exports.execute = async (interaction, commands) => {
    ...
    if (personne) embed.setDescription(`<@${interaction.member.id}> fait un sourire à <@${personne.id}> 😀`);
    else embed.setDescription(`<@${interaction.member.id}> sourit 😀`);
